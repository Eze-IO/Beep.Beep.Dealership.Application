            ...
            addButton.setOnAction(new EventHandler<ActionEvent>() {
                @Override public void handle(ActionEvent e) {
                    try {
                        ...
                        if(AddInventoryController.GetLastSaved()!=null)
                            populateView(String.valueOf(AddInventoryController.GetLastSaved().getID()));
                    }
                    catch (Exception ex) {
                        Library.writeLog(ex);
                    }
                                        ...
                                        public void handle(KeyEvent ke)
                                        {
                                            if(ke.getCode().equals(KeyCode.ENTER)){
                                                ...
                                                if(cu != null){
                                                    ...
                                                    cu.year = Integer.parseInt(np.trim());
                                                    if(Database.updateAnItem(cu)){
                                                        yv.setText(yt.getText().trim());
                                                    }
                                                }else {
                                    ...
                                    yt.textProperty().addListener((obs, oldText, newText) -> {
                                        try{
                                            if(!newText.matches("\\d*")) {
                                                yt.setText(newText.replaceAll("[^\\d]", "").trim());
                                            }
                                        }
                                        catch(Exception ex){
                                            return;
